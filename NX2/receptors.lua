...
return function(button_list, stepstype, skin_parameters)
	...
	local stepsTypeTable = {
		StepsType_Pump_Single = {
			receptor	= {"", "", NOTESKIN:get_path(skin_name, NOTESKIN:get_path(skin_name, "HD/Center Receptor")), "", ""},
		...
		StepsType_Pump_Double = {
			receptor	= {"", "", NOTESKIN:get_path(skin_name, "HD/Center Receptor"), "", "", "", "", NOTESKIN:get_path(skin_name, "HD/Center Receptor"), "", ""},
			tap			= NOTESKIN:get_path(skin_name, "HD/Tap")
		},
		...
		StepsType_Pump_Routine = {
			receptor	= {"", "", NOTESKIN:get_path(skin_name, "HD/Routine/Center Receptor"), "", "", "", "", NOTESKIN:get_path(skin_name, "HD/Routine/Center Receptor"), "", ""},
